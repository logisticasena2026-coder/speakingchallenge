export function Creditos() {
  return (
    <>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6" style={{ background: 'var(--surface-1)' }}>
        <div className="max-w-2xl mx-auto">
          <div className="cta-box p-8 sm:p-12 text-center">
            <div
            ...
            >
              ...
              ></span>
              <span className="section-label">El portal está abierto</span>
            </div>

            <h2 className="display-heading text-3xl sm:text-4xl mb-4">
              ¿Listo para <span className="text-highlight-green">despertar los verbos?</span>
            </h2>
            <p className="text-sm sm:text-base mb-8" style={{ color: 'var(--text-secondary)' }}>
              Crea tu perfil, conoce a Sophia y empieza la Era Vikinga. Tu progreso queda grabado en
              la línea temporal.
            </p>

            <div className="flex flex-col sm:flex-row gap-3 mb-6 max-w-md mx-auto">
              <input className="cta-input flex-1" type="email" placeholder="tu@correo.com" />
              <button className="btn-primary px-6 py-3 shrink-0 w-full sm:w-auto">
                Iniciar viaje
              </button>
            </div>

            <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
              Acceso anticipado · sin tarjeta · 100% en español e inglés
            </p>
