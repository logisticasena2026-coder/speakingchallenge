...
export function Stasts() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6 ani delay-anim-2">
        <div className="rounded-xl border border-white/6 bg-surface-2/70 backdrop-blur-xl p-4 sm:p-5">
        ...
        <div className="rounded-xl border border-amber-500/15 bg-surface-2/70 backdrop-blur-xl p-4 sm:p-5">
