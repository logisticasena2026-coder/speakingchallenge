...
export function ErasPractica() {
    return (
      <div className="mt-5 relative rounded-xl border border-white/6 bg-surface-2/70 backdrop-blur-xl p-6 ani delay-anim-3">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 pt-2 snap-x snap-mandatory era-scroll">
          ...
          <div className="relative shrink-0 w-65 h-40 rounded-xl overflow-hidden border border-white/6 cursor-pointer transition-all duration-300 hover:border-brand-green/30 hover:-translate-y-1">
            <img
          ...
          <div className="relative shrink-0 w-65 h-40 rounded-xl overflow-hidden border border-white/6 opacity-50 cursor-not-allowed">
            <img
