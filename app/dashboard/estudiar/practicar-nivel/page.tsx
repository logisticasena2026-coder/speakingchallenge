...
import { EstudioNivel } from '@/components/Practica/EstudioNivel';
import { Nivel } from '@/components/Practica/Nivel';

export const metadata: Metadata = {
  title: 'Estudiando nivel | speakingchallenge',
  description:
    'Modo de estudio por niveles. Practica frases y completa tu nivel para avanzar en la era.',
  robots: { index: false, follow: false },
};

export default function PracticarNivel() {
  return (
    <>
      <h1 className="sr-only">Práctica de nivel</h1>
