      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-6 ani delay-anim-2">
        ...
        <div className="mt-5 relative rounded-xl border border-white/6 bg-surface-2/70 backdrop-blur-xl ani delay-anim-4">
          ...
          <div className="flex flex-col justify-center items-center text-center p-6 sm:p-8">
            ...
            <Link href="/dashboard/estudiar/practicando" className="flex items-center justify-center gap-2 bg-brand-green text-surface-0 font-ui text-xs font-bold tracking-widest uppercase w-full sm:w-auto px-8 py-3.5 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-[0_0_24px_rgba(61,214,140,0.4)] hover:-translate-y-0.5">
              <Play className="w-5 h-5" />
              Iniciar practica
            </Link>
          </div>
