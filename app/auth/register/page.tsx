...
export default function Register() {
  return (
    <>
      ...
      <main className="relative z-10 grow flex items-center justify-center px-container-px-mobile md:px-container-px-desktop py-24">
